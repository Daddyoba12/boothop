...
const NAV_LINKS = [
  ['How It Works',      '/business/how-it-works'],
  ['Pricing',           '/business/pricing'],
  ['Priority Partner',  '/business/priority-partner'],
      ...
      <div className="mx-auto max-w-7xl px-6 py-8 md:px-8">
        ...
        <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between mb-5">
          ...
          <div className="flex flex-wrap items-center gap-x-5 gap-y-1 text-sm text-white/40">
            <a href="mailto:business@boothop.com" className="hover:text-white transition-colors">
              business@boothop.com
            </a>
            <a href="tel:+441156612825" className="hover:text-white transition-colors">
              +44 115 661 2825
            </a>
            <a href="/api/whatsapp"
              className="inline-flex items-center gap-1.5 text-[#25D366]/70 hover:text-[#25D366] transition-colors text-xs font-semibold">
        ...
        <div className="flex flex-col gap-3 border-t border-white/5 pt-5 md:flex-row md:items-center md:justify-between">
          <div>
            <p className="text-xs text-white/25">© {new Date().getFullYear()} BootHop Ltd · Business Services</p>
