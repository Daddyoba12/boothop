    ...
    html: `
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:32px 24px;color:#0f172a;background:#ffffff;">
        ...
        <table style="width:100%;border-collapse:collapse;margin-bottom:24px;font-size:14px;">
          ...
          <tr style="background:#f8fafc;"><td style="padding:10px 14px;color:#64748b;font-weight:600;">Insurance (7.5%)</td><td style="padding:10px 14px;">${params.insuranceAccepted ? `£${params.insuranceFee.toFixed(2)}` : 'Not selected'}</td></tr>
