  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      <div>
        ...
        <p style={{ color: '#6B7280', fontSize: 13, margin: 0 }}>Manually post content to TikTok or Instagram</p>
      </div>

      {/* Info banner */}
      <div style={{ background: '#1E3A5F', borderRadius: 12, padding: 16, fontSize: 13, color: '#93C5FD', lineHeight: 1.6 }}>
        <strong>How to post manually:</strong><br />
        ...
        3. Once rendered (status = "rendered"), click <strong>↑ TikTok</strong> or <strong>↑ Instagram</strong> to post.<br />
