...
export default function PromoOverview() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 28 }}>
      <div>
        <h1 style={{ fontSize: 22, fontWeight: 800, margin: '0 0 4px', color: '#F9FAFB' }}>🎯 BootHop Promo — Overview</h1>
        <p style={{ color: '#6B7280', fontSize: 13, margin: 0 }}>Real-time status of your social content pipeline</p>
      </div>
