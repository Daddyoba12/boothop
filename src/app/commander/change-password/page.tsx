...
export default function CommanderChangePasswordPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const res = await fetch('/api/commander/change-password', {
      method:  'POST',
    ...
    setSuccess(true);
    setTimeout(() => router.push('/commander/dashboard'), 2000);
  }
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-xl p-8 shadow-[0_32px_80px_rgba(0,0,0,0.5)]">
          {success ? (
            <div className="text-center py-4">
              ...
              <p className="text-sm text-white/40">Taking you to the dashboard…</p>
            </div>
          ) : (
            <>
              <div className="mb-6">
