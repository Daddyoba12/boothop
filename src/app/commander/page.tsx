...
export default function CommanderPage() {
  ...
  const select = "w-full rounded-xl border border-slate-700 bg-slate-800 px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-orange-500/30 focus:border-orange-500 transition-all text-sm appearance-none";
  ...
  return (
    <div className="min-h-screen bg-slate-900 flex flex-col items-center justify-center px-4 py-12">
      <div className="absolute top-6 left-6">
        <Link href="/" className="text-slate-500 hover:text-slate-300 transition-colors text-sm font-medium">← BootHop</Link>
      </div>
      ...
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <div className="mt-3 flex items-center gap-2">
            <span className="text-[10px] font-bold uppercase tracking-[0.15em] text-slate-500">Pipeline</span>
        ...
        <div className="rounded-2xl border border-slate-700 bg-slate-800/80 backdrop-blur-sm shadow-2xl shadow-black/40 p-8">
          ...
          {tab === 'register' && (
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              <div>
                <label className={label}>Company ID <span className="normal-case text-slate-500 font-normal">(your login username)</span></label>
                ...
                <p className="mt-1 text-[10px] text-slate-500">Lowercase letters, numbers and hyphens only</p>
              </div>
              <div>
              ...
              <div>
                <label className={label}>Password <span className="normal-case text-slate-500 font-normal">(min 8 characters)</span></label>
        ...
        <p className="mt-5 text-center text-xs text-slate-600">
          Need help?{' '}
          <a href="/contact" className="text-slate-400 hover:text-white underline underline-offset-2 transition-colors">
            Contact support
          </a>
        </p>
      </div>
